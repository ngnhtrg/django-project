# Generated by Django 4.2.11 on 2024-04-27 20:14
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Category',
            fields=[
                ('ru_name', models.CharField(default='', max_length=255, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='ProductColor',
            fields=[
                ('ru_value', models.CharField(default='', max_length=255, primary_key=True, serialize=False)),
                ('en_value', models.CharField(default='', max_length=255)),
                ('created_at', models.DateTimeField(default=django.utils.timezone.now)),
                ('deleted_at', models.DateTimeField(blank=True, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='ProductGroup',
            fields=[
                ('group_id', models.CharField(default='', max_length=255, primary_key=True, serialize=False)),
